...
class ComboBoxWindow(Gtk.Window):
    def __init__(self):
        ...
        name_store.append([0, "Andrew Adams"])
        name_store.append([11, "Nancy Edwards"])
        name_store.append([12, "Michael Mitchell"])
        name_store.append([21, "Jane Peacock"])
        name_store.append([22, "Margaret Park"])
        name_store.append([23, "Steve Johnson"])
        name_store.append([61, "Robert King"])
        name_store.append([62, "Laura Callahan"])
        ...
        name_combo.set_active(2)    # Michael Mitchell
